...
`spark config identify` tells you the current profile, IP address and access token that Spark-Cli is pointing to. This is useful to confirm that you are connecting to the correct server.

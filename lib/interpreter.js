...
Interpreter.prototype = {
	...
	startup: function () {
		...
		console.log(chalk.yellow('!!!'), 'We have news! Spark has rebranded as', chalk.bold.cyan('Particle'));
		console.log(chalk.yellow('!!!'), 'Learn more at', chalk.cyan('http://blog.particle.io/2015/05/13/spark-is-now-particle/'));
		console.log();
		console.log(chalk.yellow('!!!'), chalk.bold.white('particle-cli'), 'will be the new CLI tool.', chalk.magenta('spark-cli'), 'will soon be deprecated.');
		// console.log(chalk.yellow('!!!'), 'Install it now by running', chalk.bold.white('npm install -g particle-cli'));
	},
